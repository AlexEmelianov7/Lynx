sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/WorklistEventBus/app", ".html");
		...
		return Opa5.extend("zjblessons.WorklistEventBus.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/WorklistEventBus/localService/mockserver"], function (mockserver) {
