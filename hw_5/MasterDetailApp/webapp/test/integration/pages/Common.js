sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("zjblessons/MasterDetailApp/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("zjblessons.MasterDetailApp.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["zjblessons/MasterDetailApp/localService/mockserver"], function (mockserver) {
