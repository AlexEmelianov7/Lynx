sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/WorklistCustomControl/app", ".html");
		...
		return Opa5.extend("zjblessons.WorklistCustomControl.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/WorklistCustomControl/localService/mockserver"], function (mockserver) {
